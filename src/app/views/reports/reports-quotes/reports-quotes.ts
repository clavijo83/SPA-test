...
@Component({
  selector: 'app-reports-quotes',
  standalone: false,
  templateUrl: './reports-quotes.html',
  styleUrl: './reports-quotes.css',
})
export class ReportsQuotes implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingSubmittedQuotes$.subscribe(value => {

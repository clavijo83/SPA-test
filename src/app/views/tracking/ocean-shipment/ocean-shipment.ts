...
@Component({
  selector: 'app-ocean-shipment',
  standalone: false,
  templateUrl: './ocean-shipment.html',
  styleUrl: './ocean-shipment.css',
})
export class OceanShipment implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingOcean$.subscribe(value => {

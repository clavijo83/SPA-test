...
@Component({
  ...
  standalone: false,
  templateUrl: './submitted-quotes.html',
  styleUrl: './submitted-quotes.css',
})
export class SubmittedQuotes implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingTruckloadSubmittedQuotes$.subscribe(value => {

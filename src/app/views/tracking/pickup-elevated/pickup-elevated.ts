...
@Component({
  selector: 'app-pickup-elevated',
  standalone: false,
  templateUrl: './pickup-elevated.html',
  styleUrl: './pickup-elevated.css',
})
export class PickupElevated implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingPickupElevated$.subscribe(value => {

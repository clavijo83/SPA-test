...
@Component({
  selector: 'app-mabd-appointment',
  standalone: false,
  templateUrl: './mabd-appointment.html',
  styleUrl: './mabd-appointment.css',
})
export class MabdAppointment implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingMABD$.subscribe(value => {

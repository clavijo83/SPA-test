...
@Component({
  selector: 'app-booked-not-late',
  standalone: false,
  templateUrl: './booked-not-late.html',
  styleUrl: './booked-not-late.css',
})
export class BookedNotLate implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingBookedNotLate$.subscribe(value => {

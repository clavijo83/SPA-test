...
@Component({
  selector: 'app-truckload-failure',
  standalone: false,
  templateUrl: './truckload-failure.html',
  styleUrl: './truckload-failure.css',
})
export class TruckloadFailure implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingTruckloadFailure$.subscribe(value => {

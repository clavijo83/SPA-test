...
@Component({
  selector: 'app-truckload-problem',
  standalone: false,
  templateUrl: './truckload-problem.html',
  styleUrl: './truckload-problem.css',
})
export class TruckloadProblem implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingTruckloadProblem$.subscribe(value => {

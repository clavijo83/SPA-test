...
@Component({
  selector: 'app-guaranteed',
  standalone: false,
  templateUrl: './guaranteed.html',
  styleUrl: './guaranteed.css',
})
export class Guaranteed implements OnInit {
  ...
  ngOnInit() {
    // this.utilityService.trackingGuaranteed$.subscribe(value => {

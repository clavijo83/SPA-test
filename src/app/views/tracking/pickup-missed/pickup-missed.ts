...
@Component({
  selector: 'app-pickup-missed',
  standalone: false,
  templateUrl: './pickup-missed.html',
  styleUrl: './pickup-missed.css',
})
export class PickupMissed implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingLatePickups$.subscribe(value => {

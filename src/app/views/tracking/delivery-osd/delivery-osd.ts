...
@Component({
  selector: 'app-delivery-osd',
  standalone: false,
  templateUrl: './delivery-osd.html',
  styleUrl: './delivery-osd.css',
})
export class DeliveryOsd implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingDeliveryOSD$.subscribe(value => {

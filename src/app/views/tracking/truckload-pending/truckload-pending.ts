...
@Component({
  selector: 'app-truckload-pending',
  standalone: false,
  templateUrl: './truckload-pending.html',
  styleUrl: './truckload-pending.css',
})
export class TruckloadPending implements OnInit {
  ...
  ngOnInit() {
    this.utilityService.trackingTruckloadPending$.subscribe(value => {
